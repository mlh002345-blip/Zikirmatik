...
export const dhikrPresets: DhikrPreset[] = [
  ...
  { id: 'salavat', arabic: 'اَللّٰهُمَّ صَلِّ عَلَى مُحَمَّد', transliteration: 'Salli Allahumme', meaning: 'Peygambere salavat', defaultTarget: 100 },
  ...
  { id: 'kelimeitevhid', arabic: 'لَا إِلٰهَ إِلَّا اللّٰهُ وَحْدَهُ لَا شَرِيكَ لَه', transliteration: 'Kelime-i Tevhid', meaning: 'Birleme kelimesi', defaultTarget: 70000 },
];
